...
from .views import create_coding_table_view, create_coding_table_disjonctif_complet_view, create_tableau_de_distance_view, create_tableau_de_burt_view, get_pie_data
urlpatterns = [
